...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, onOpen }) => {
  return (
    <button
      ...
      title={project.path}
      className="group min-w-0 text-left bg-white rounded-xl border border-[#EAEAEA] hover:border-[#C8C8C8] hover:shadow-sm transition-all p-5 flex flex-col cursor-pointer"
    >
      ...
      <div className="flex flex-wrap items-center justify-between gap-x-3 gap-y-1 pt-3 border-t border-[#EAEAEA] mt-auto w-full">
